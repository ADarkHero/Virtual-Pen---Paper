...
//Read character data from database
    ...
    while ($row = $statement->fetch()) {
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <!-- PICTURE UPLOAD -->
            <div class="form-group row">
                <div class="col-md-2 form" data-toggle="tooltip" title="Picture upload">
                ...
                <div class="col-md-3 form" data-toggle="tooltip" title="Secondary picture">
                    <input class="form-control" type="file" name="secondaryPicture">
                </div>
                <div class="col-md-3 form" data-toggle="tooltip" title="Tertiary picture">
            ...
            <!-- NAME -->
            <div class="form-group row">
                <div class="col-md-2 form" data-toggle="tooltip" title="First Name">
                ...
                <div class="col-md-2 form" data-toggle="tooltip" title="Last Name">
            ...
            <div class="form-group row">
                <div class="col-md-1 form" data-toggle="tooltip" title="Sex">
                ...
                <div class="col-md-1 form" data-toggle="tooltip" title="Birthday">
                ...
                <div class="col-md-1 form" data-toggle="tooltip" title="Age">
            ...
            <div class="form-group row">
                <div class="col-md-1 form" data-toggle="tooltip" title="Weight">
                ...
                <div class="col-md-1 form" data-toggle="tooltip" title="Size">
                ...
                <div class="col-md-1 form" data-toggle="tooltip" title="Eyecolor">
                ...
                <div class="col-md-1 form" data-toggle="tooltip" title="Hairstyle">
            ...
            ?>
            <div class="form-group row">
                <div class="col-md-2 form" data-toggle="tooltip" title="Race">
                ...
                <div class="col-md-2 form" data-toggle="tooltip" title="Subrace">
            ...
            ?>
            <div class="form-group row">
                <div class="col-md-2 form" data-toggle="tooltip" title="Class">
                ...
                <div class="col-md-2 form" data-toggle="tooltip" title="Subclass">
            ...
            <!-- WEAPON -->
            <div class="form-group row">
                <div class="col-md-2 form" data-toggle="tooltip" title="Weapon">
                ...
                <div class="col-md-2 form" data-toggle="tooltip" title="Subweapon">
